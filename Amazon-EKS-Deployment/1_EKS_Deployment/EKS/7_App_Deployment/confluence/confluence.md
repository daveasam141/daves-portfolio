...
### You can install confluence using a script (install-confluence.sh it is one of the files in the repo. To run the script, it must have execute permissions. also make sure you chnage the username and password in line 3 of the script to your database username and password)
